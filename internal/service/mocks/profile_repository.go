...
func (_m *ProfileRepository) AddRefreshToken(ctx context.Context, refreshToken []byte, id uuid.UUID) error {
...
func (_m *ProfileRepository) DeleteProfile(ctx context.Context, id uuid.UUID) error {
...
func (_m *ProfileRepository) GetPasswordAndIDByUsername(ctx context.Context, username string) (uuid.UUID, []byte, error) {
...
func (_m *ProfileRepository) GetRefreshTokenByID(ctx context.Context, id uuid.UUID) ([]byte, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ProfileRepository) SignUp(ctx context.Context, profile *model.Profile) error {
